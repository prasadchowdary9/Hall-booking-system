 ...
 * com.example.demo.security.JwtAuthenticationFilter; import
 * com.example.demo.service.CustomUserDetailsService; import
 ...
 * .authorizeHttpRequests(auth -> auth .requestMatchers( "/api/users/signup",
 * "/api/users/login", "/api/users/forgot-password", "/swagger-ui/**",
